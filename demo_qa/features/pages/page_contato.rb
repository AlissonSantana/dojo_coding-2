class PageFormulario < SitePrism::Page
	...
	element :mensagem_sucesso, "div[class='wpcf7-response-output wpcf7-display-none wpcf7-mail-sent-ok']"
	element :mensagem_insucesso, "div[class='wpcf7-response-output wpcf7-display-none wpcf7-validation-errors']"
	element :texto_invalido, "span[class='wpcf7-not-valid-tip']"
